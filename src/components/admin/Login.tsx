                    ...
                    <div className='mt-4'>
                        <form className='flex justify-start items-start flex-col gap-4 w-[100%]'>
                            <div className='flex flex-col justify-start items-start w-[100%]'>
                                ...
                                <input type="email" value={'admin@yopmail.com'} placeholder='enter your email' className='w-[100%] px-2 py-2 rounded-md border-black border-[1px]' {...register('email', { required: true })} />
                                {errors.email && <span className='text-red-500'>Email is required</span>}
                            </div>
                            <div>
                                <label className='font-[600px] text-[14px] leading-[18px] text-[#202020]'>password</label>
                                <div className='relative'>
                                    <input type={showPassword ? 'text' : 'password'} value={123456} placeholder='enter your email' className='w-[100%] px-2 py-2 rounded-md border-black border-[1px]' {...register('password', { required: true })} />
